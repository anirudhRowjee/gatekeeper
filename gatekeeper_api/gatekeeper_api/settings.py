"""
Django settings for gatekeeper_api project.
...
SECRET_KEY = 'ahkz-)kgo@d+f6pc*_$3#crtq1mz5pwanmpov1b*gelgmiedpc'
...
ROOT_URLCONF = 'gatekeeper_api.urls'
...
WSGI_APPLICATION = 'gatekeeper_api.wsgi.application'
